...
type User struct{ //用户表
	Id 			int
	Name 		string`orm:"size(20);unique" form:"user_name"` 		//用户名
	PassWord 	string`orm:"size(20)" form:"pwd" `	 //登陆密码
	Email 		string`orm:"size(50)" form:"email"`   	//邮箱
...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:yidong@tcp(112.74.172.1:3306)/dailyfresh?charset=utf8")
